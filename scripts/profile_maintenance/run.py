...
def prepare(config, readme, client, *, api_key='', dry_run=False, force=False):
    ...
    proposal = load_proposal(client, config, old_state, readme)
...
def main(argv=None):
    ...
    if args.command == 'prepare':
        ...
        # A local dry-run may intentionally inspect a proposed README before merge.
        if not args.dry_run:
